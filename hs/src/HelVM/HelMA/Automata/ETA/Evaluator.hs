...
uncurryEval :: Evaluator Symbol m => (Source , StackType) -> SafeMonadT m ()
...
evalTL :: Evaluator Symbol m => TokenList -> StackType -> SafeMonadT m ()
...
doInstruction :: SEvaluator e s m => Maybe Token -> InstructionUnit -> s -> SafeMonadT m ()
-- IO instructions
