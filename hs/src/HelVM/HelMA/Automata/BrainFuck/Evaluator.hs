...
batchEvalInt8 = flipEvalInt8 emptyInput

flipEvalInt8 :: Input -> Source -> Output
flipEvalInt8 = flip evalInt8

batchEvalWord8 :: Source -> Output
batchEvalWord8  = flipEvalWord8 emptyInput

flipEvalWord8 :: Input -> Source -> Output
flipEvalWord8  = flip evalWord8
